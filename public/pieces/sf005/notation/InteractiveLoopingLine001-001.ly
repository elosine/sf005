    ...
    \new StaffGroup <<
...

      {
       ...
       \time 2/8
        ...
        g'8-^ gis'4.
        \time 12/8
        c''32-^ fis'8 ees''32 a'8. \tuplet 3/2 {d'4 e'' b'} b'32 d''8 \tuplet 5/4 {f''16 a' a'8 b'16}   c''32 des''16 f'' gis''32 bes''16.
        \time 2/4
        bes''2-^
      ...
      }
      {
       ...
       \time 5/8
        ...
        c''4-^ c' c'
        \time 35/32
        c''32-^ c' c' c' c'  c'32 c' c''-^ c' c''-^  c'32 c' c' c' c''-^  c''32-^ c' c' c''-^ c'  c'32 c' c' c''-^ c'  c''32-^ c' c' c' c'  c'32 c' c''-^ c' c''-^
        \time 4/8
        c''8-^ c' c' c'
        \time 12/8
